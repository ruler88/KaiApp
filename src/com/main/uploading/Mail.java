...
public class Mail extends javax.mail.Authenticator { 
  ...
  public Mail(String fileAttachment) throws Exception { 
    ...
    _from = username; // email sent from 
    
    _subject = "Android app auto generated email"; // email subject 
    _body = "Android app auto generated email"; // email body 
    _to = new String[1];
    _to[0] = to;
